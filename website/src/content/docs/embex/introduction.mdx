---
title: Introduction
description: Embex is the universal vector database client that lets you switch providers without rewriting code.
---
...
**Embex** is a high-performance, universal client for vector databases. It allows you to write your code once and run it with any supported provider (LanceDB, Qdrant, Pinecone, and more).
