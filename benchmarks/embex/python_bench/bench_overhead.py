...
try:
    ...
    print("Embex imported successfully")
except ImportError:
    print("Failed to import embex. Make sure bindings are built and in PYTHONPATH")
    sys.exit(1)
...
def bench_point_creation(count: int, dim: int):
    ...
    embex_time = time.time() - start
    print(f"Embex: {embex_time:.4f}s ({count/embex_time:.0f} ops/s)")
    ...
    if 'models' in globals():
        ...
        print(f"Speedup: {qdrant_time/embex_time:.2f}x")
