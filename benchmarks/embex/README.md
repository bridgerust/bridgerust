# Embex Performance Benchmarks

This directory contains performance benchmarks for the Embex vector database ORM.
...
Measures the overhead of core Embex operations:
...
**Use Case**: Understanding the overhead of Embex's abstraction layer for basic operations.
...
Measures overhead of various Embex components:

- **Filter Conversion**: Converting JSON filters to Embex `Filter` types (simple and complex)
...
- **Client Initialization**: Overhead of creating `EmbexClient` instances
...
Based on benchmark results, Embex adds minimal overhead:
